...
<form method="POST" action="?/editUser" use:enhance>
    ...
    <Form.Field {form} name="email">
        <Form.Control let:attrs>
            ...
            <Input placeholder="me@me.com" type="email" bind:value={$formData.email} required />
        </Form.Control>
    </Form.Field>
    ...
    <Form.Field {form} name="firstName">
        <Form.Control let:attrs>
            ...
            <Input placeholder="John" type="text" bind:value={$formData.firstName} required />
        </Form.Control>
    </Form.Field>
    ...
    <Form.Field {form} name="lastName">
        <Form.Control let:attrs>
            ...
            <Input placeholder="Doe" type="text" bind:value={$formData.lastName} required />
        </Form.Control>
    </Form.Field>
